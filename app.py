...
if 'Tenure' in df.columns:
    ...
    fig8 = px.histogram(df, x='Tenure', color='Exited',
                        title="Churn Distribution by Customer Tenure", template="plotly_white", barmode='group')
...
linkedin_url = "https://www.linkedin.com/in/abhinandan-saini-618339316/"  # <-- change this to your actual LinkedIn
github_url = "https://github.com/AbhinandanS4"  # optional
